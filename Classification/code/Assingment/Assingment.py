...
def testLR(ntheta, X):
    ...
    probability = Tsigmoid(X * theta.T)
...
if __name__ == '__main__':
    ...
    X,Y = get_data("C:\\Users\\decim\\Desktop\\Assingment1\\diabetes")
    ...
    alpha = 0.001
    iterations = 1000
    TR_theta = Logistic_Regression(Xtr,Ytr,alpha,initial_theta,iterations)
    # print(len(TR_theta))
    # TR_theta=np.matrix(TR_theta)
    # print(type(TR_theta))
    Y_pred = testLR(TR_theta, Xte)
    # print(Y_pred)
    print("Classification accuracy:", accuracy(Yte, Y_pred))
